# aenima — Design Specification v2.4 (web)
...
:root {
  ...
  --n-placeholder: #737780; /* placeholders only — fails AA by design */
...
*v2.4 — complete and closed: no open items. Changes cut new versions of this document.*
