...
- product-spec §4 records that a condition may carry probes — one sentence, v1.7
...
- AC4 product-spec §4 says a condition may carry probes, at v1.7
...
- TC4 → AC4 `node scripts/run/version-drift.mjs "product-spec v1.6 §4, §5 · build-log OQ22"`
  reports product-spec cited 1.6, repo 1.7, `drifted: true`; the reviewer reads the §4 sentence
