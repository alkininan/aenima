...
- **AC3** docs/guidelines.md is v1.7; §5's capability-boundary paragraph says the production
...
- **TC3 → AC3** `node scripts/run/version-drift.mjs "guidelines v1.7 §5"` reports
...
`version-drift.mjs "guidelines v1.12 §5"`. This round builds AA1–AA3 and nothing else.
