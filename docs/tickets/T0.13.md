...
T0.11 while this task waited. The addendum round below moves it again, to v1.12, and AC3 and TC3
now name that.
...
- **AC3** docs/guidelines.md is v1.12; §5's capability-boundary paragraph says the production
...
- **TC3 → AC3** `node scripts/run/version-drift.mjs "guidelines v1.12 §5"` reports
